...
const PUBLIC_PROFILES = {
  ...
  'chat-seller-1': {
    ...
    bio: 'Официальный представитель InstaStore. Помогаю с подбором размеров и оформлением заказов 🛍️',
    baseFollowers: 8900,
    following: 154,
  ...
  'chat-logistic': {
    ...
    bio: 'Логистика InstaStore. Быстрая доставка по всей стране. Вопросы по доставке пишите сюда 📦',
    baseFollowers: 3200,
    following: 89,
    products: [],
    reels: []
  ...
  'chat-support': {
    id: 'chat-support',
    name: 'instastore_official',
    fullName: 'InstaStore Shop',
    avatar: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=150&auto=format&fit=crop&q=60',
    bio: 'Магазин твоих желаний в один клик ✨ Тренды, новинки, качество. Доставка по всей России.',
    baseFollowers: 45000,
    following: 12,
...
export default function Profile() {
  ...
  const profile = isMe 
    ? {
        ...
        bio: 'Клиент InstaStore 🛍️. Обожаю стильные вещи и качественный звук.',
        baseFollowers: 152,
